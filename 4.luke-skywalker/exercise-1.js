...
const adventureVideogames = videogames.filter(item => item.genders.includes("Aventura"))
const averageScore = adventureVideogames.reduce((acc, item) => {
  acc += item.score / adventureVideogames.length
  return acc
}, 0)
